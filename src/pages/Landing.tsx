      ...
      {/* Hero Section */}
        ...
        className="relative h-screen flex items-center justify-center bg-background">
          ...
          <div className="relative z-10 text-center px-4 max-w-4xl ">
           <h1 className="font-logo text-5xl md:text-7xl mb-6 leading-tight text-foreground">
            Sadelmakeriet
          </h1>
            <p className="text-xl font-sans md:text-2xl mb-8 text-foreground max-w-2xl mx-auto leading-relaxed">
