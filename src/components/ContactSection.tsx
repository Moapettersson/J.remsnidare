...
import { Mail, Phone, Calendar, Instagram, MapPin } from "lucide-react";
  ...
  return (
    <section className={`py-16 px-4 ${className}`} style={{ backgroundColor: "var(--background)" }}>
      <div className="max-w-5xl mx-auto text-center">
        ...
        {/* Kontaktkort */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8 justify-center items-stretch">
          ...
          <Card className="p-6 bg-beige-100 hover:shadow-elegant transition-all duration-300 hover:bg-beige-800 hover:text-beige-900">
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <div>
                <h3 className="text-lg mb-2 text-foreground">Besöksadress</h3>
                <p className="text-sm text-foreground">
                  Slakterigatan 10<br />
                  721 32 Västerås
                </p>
                <p className="text-xs text-muted-foreground mt-2">
                  Slakteriet i Västerås, innergården (mittemot blomsteraffären)
                </p>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-6 bg-beige-100 hover:shadow-elegant transition-all duration-300 hover:bg-beige-800 hover:text-beige-900">
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <div>
                ...
                <a href="https://www.instagram.com/j_remsnidare/"
                  target="_blank" 
        ...
        <div className="mt-8 p-4 rounded-lg bg-secondary/30">
          <p className="text-sm text-foreground">
            <strong>Öppettider:</strong> Torsdag - Fredag 09:00-18:00 | 
            <strong className="ml-2">Övriga tider:</strong> Enligt överenskommelse
          </p>
        </div>
      </div>
    </section>
